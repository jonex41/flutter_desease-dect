...
import 'package:flutter_disease_dectection/presentation/tomatoes_recommendation_screen.dart';
import 'package:flutter_hooks/flutter_hooks.dart';
import 'package:image_picker/image_picker.dart';
import 'package:nb_utils/nb_utils.dart';
import 'package:tflite_v2/tflite_v2.dart';

class TomatoesScreen extends HookWidget {
  const TomatoesScreen({super.key});
              ...
              GenButton(
                  ...
                  onPress: () async {
                    ...
                    Navigator.of(context).pushReplacement(MaterialPageRoute(
                        builder: (context) =>
                            const TomatoesRecommendationScreen()));
